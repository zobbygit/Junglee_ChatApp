...
const CreateChannel = () => {
    ...
    return (<>
        <Tooltip>
        <TooltipTrigger><FaPlus onClick={()=>setNewChannelModal(true)} className="text-neutral-400 font-light text-opacity-90 text-start hover:text-neutral-100 cursor-pointer transition-all"/></TooltipTrigger>
        ...
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] gap-10 h-[400px] flex flex-col ">
            ...
            <div>
                <Input placeholder="Channel Name " onChange={e => setChannelName(e.target.value)} className="rounded-lg p-6 bg-[#2c2e3b] border-none"/>
            </div>
            <div>
